...
function validateCompatibility(compatibility, diagnostics) {
...
Options:
  ...
  if (jsonOutput) {
    ...
    for (const skill of result.skills) {
      ...
      const filtered = quiet ? skill.diagnostics.filter((d) => d.severity === "error") : skill.diagnostics;
